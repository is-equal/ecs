...
module.exports = {
  ...
  beforeAll(context) {
    ...
    context.world.registerSystem(ABSystem).registerSystem(CDSystem).registerSystem(CESystem);

    for (let i = 0; i < 1000; i++) {
      context.world.createEntity().addComponent(A, { value: 0 }).addComponent(B, { value: 1 });
      context.world
        .createEntity()
